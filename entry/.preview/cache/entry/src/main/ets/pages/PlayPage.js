...
class PlayPage extends ViewPU {
    ...
    initialRender() {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Image.create({ "id": 16777232, "type": 20000, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
    ...
    TabTitle(title, index, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.fontColor(this.currentTabIndex === index ? { "id": 16777263, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } : { "id": 16777264, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            ...
            Text.border({
                ...
                color: { "id": 16777263, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
            });
