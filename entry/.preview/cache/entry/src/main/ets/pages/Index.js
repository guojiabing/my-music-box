...
class Index extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            GridRow.debugLine("pages/Index.ets(20:5)");
            GridRow.padding({
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            GridCol.debugLine("pages/Index.ets(33:7)");
            if (!isInitialRender) {
                GridCol.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.debugLine("pages/Index.ets(44:9)");
            if (!isInitialRender) {
                Column.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Stack.create();
                    Stack.debugLine("pages/Index.ets(46:13)");
                    if (!isInitialRender) {
                        Stack.pop();
                    }
                    ViewStackProcessor.StopGetAccessRecording();
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    Image.debugLine("pages/Index.ets(47:15)");
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Column.create();
                    Column.debugLine("pages/Index.ets(51:15)");
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("pages/Index.ets(52:17)");
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("pages/Index.ets(55:17)");
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Blank.create();
                    Blank.debugLine("pages/Index.ets(62:17)");
                    if (!isInitialRender) {
                        Blank.pop();
                    }
                    ViewStackProcessor.StopGetAccessRecording();
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Column.create();
                    Column.debugLine("pages/Index.ets(63:17)");
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    Button.debugLine("pages/Index.ets(64:19)");
                    Button.backgroundColor({ "id": 16777245, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("pages/Index.ets(65:21)");
