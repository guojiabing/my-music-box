...
export class ControlComponent extends ViewPU {
    ...
    updatePlay() {
        playControl.forEach((item, index) => {
            if (index === PlayConstants.PLAY_INDEX) {
                item.icon = this.isPlay ? { "id": 16777552, "type": 20000, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } : { "id": 16777221, "type": 20000, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" };
    ...
    initialRender() {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Slider.blockColor({ "id": 16777263, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            Slider.selectedColor({ "id": 16777263, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            Slider.trackColor({ "id": 16777266, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
