...
export class MusicInfoComponent extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("components/MusicInfoComponent.ets(35:5)");
            Column.margin({ left: { "id": 16777484, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }, right: { "id": 16777484, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            GridRow.debugLine("components/MusicInfoComponent.ets(36:7)");
            if (!isInitialRender) {
                GridRow.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            GridCol.debugLine("components/MusicInfoComponent.ets(44:9)");
            if (!isInitialRender) {
                GridCol.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            GridCol.debugLine("components/MusicInfoComponent.ets(58:9)");
            if (!isInitialRender) {
                GridCol.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Blank.create();
            Blank.debugLine("components/MusicInfoComponent.ets(66:7)");
            if (!isInitialRender) {
                Blank.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            GridRow.debugLine("components/MusicInfoComponent.ets(67:7)");
            if (!isInitialRender) {
                GridRow.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            GridCol.debugLine("components/MusicInfoComponent.ets(75:9)");
            if (!isInitialRender) {
                GridCol.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
    ...
    CoverInfo(parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("components/MusicInfoComponent.ets(96:5)");
            Image.constraintSize({ maxWidth: new BreakpointType({
                    sm: { "id": 16777309, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" },
                    md: { "id": 16777309, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" },
                    lg: { "id": 16777310, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
                }).getValue(this.currentBreakpoint) });
            Image.width(StyleConstants.FULL_WIDTH);
            Image.aspectRatio(1);
            Image.borderRadius({ "id": 16777313, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            Image.margin({
                left: new BreakpointType({
                    sm: { "id": 16777416, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
                }).getValue(this.currentBreakpoint),
                right: new BreakpointType({
                    sm: { "id": 16777417, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
                }).getValue(this.currentBreakpoint),
                top: new BreakpointType({
                    sm: { "id": 16777420, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" },
                    md: { "id": 16777419, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" },
                    lg: { "id": 16777418, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
                }).getValue(this.currentBreakpoint)
            });
            if (!isInitialRender) {
                Image.pop();
    ...
    MusicInfo(parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("components/MusicInfoComponent.ets(122:5)");
            Column.margin({ top: { "id": 16777410, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } });
            if (!isInitialRender) {
                Column.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("components/MusicInfoComponent.ets(123:7)");
            if (!isInitialRender) {
                Flex.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("components/MusicInfoComponent.ets(124:9)");
            Text.fontSize({ "id": 16777327, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("components/MusicInfoComponent.ets(127:9)");
            Image.width({ "id": 16777484, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            Image.aspectRatio(1);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("components/MusicInfoComponent.ets(133:7)");
            Text.textAlign(TextAlign.Start);
            Text.fontSize({ "id": 16777322, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            Text.fontColor({ "id": 16777265, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            Text.margin({ top: { "id": 16777421, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } });
    ...
    OperationInfo(parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("components/MusicInfoComponent.ets(145:5)");
            if (!isInitialRender) {
                Flex.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    Image.debugLine("components/MusicInfoComponent.ets(147:9)");
                    Image.aspectRatio(1);
                    Image.width(new BreakpointType({
                        ...
                        lg: { "id": 16777423, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
                    }).getValue(this.currentBreakpoint));
                    Image.objectFit(ImageFit.Contain);
