...
class PlayPage extends ViewPU {
    ...
    initialRender() {
            ...
            if (this.currentBreakpoint === PlayConstants.LG) {
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Tabs.vertical(false);
                        Tabs.barHeight({ "id": 16777319, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Image.create({ "id": 16777513, "type": 20000, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            Image.width({ "id": 16777348, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            Image.height({ "id": 16777348, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            Image.margin({ left: { "id": 16777484, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }, top: { "id": 16777347, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } });
    ...
    TabTitle(title, index, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create(title);
            Text.fontColor(this.currentTabIndex === index ? { "id": 16777273, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } : { "id": 16777274, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            ...
            Text.fontSize(new BreakpointType({
                sm: { "id": 16777323, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" },
                md: { "id": 16777326, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
            }).getValue(this.currentBreakpoint));
            Text.border({
                width: { bottom: this.currentTabIndex === index ? { "id": 16777469, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } : 0 },
                color: { "id": 16777273, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
            });
            Text.padding({ bottom: { "id": 16777470, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } });
            if (!isInitialRender) {
                Text.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
