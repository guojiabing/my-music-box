...
class MusicList extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Stack.backgroundColor(this.currentBreakpoint === BreakpointConstants.BREAKPOINT_SM ? { "id": 16777266, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } : { "id": 16777265, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            if (!isInitialRender) {
                Stack.pop();
            }
