...
export class PlayControlComponent extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.width(this.index === PlayConstants.PLAY_INDEX ? new BreakpointType({
                sm: { "id": 16777444, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" },
                md: { "id": 16777444, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" },
    ...
    playControlClick(key) {
        switch (key) {
            ...
            case ControlConstants.PLAY:
                ...
                this.playControl.icon = { "id": 16777539, "type": 20000, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" };
                this.playControl.key = ControlConstants.PAUSE;
                break;
            case ControlConstants.PAUSE:
                MediaService.getInstance().pause();
                this.playControl.icon = { "id": 16777536, "type": 20000, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" };
    ...
    changePlayMode() {
        ...
        const resource = [{ "id": 16777545, "type": 20000, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }, { "id": 16777521, "type": 20000, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }, { "id": 16777524, "type": 20000, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }];
