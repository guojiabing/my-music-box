    ...
    updatePlay() {
        playControl.forEach((item, index) => {
            if (index === PlayConstants.PLAY_INDEX) {
                item.icon = this.isPlay ? { "id": 16777539, "type": 20000, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } : { "id": 16777536, "type": 20000, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" };
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.margin({
                ...
                bottom: { "id": 16777319, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
            });
            if (!isInitialRender) {
                Column.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Flex.margin({ top: { "id": 16777415, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }, bottom: { "id": 16777415, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } });
            if (!isInitialRender) {
                Flex.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.width({ "id": 16777458, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            ...
            Text.fontSize(new BreakpointType({
                ...
                lg: { "id": 16777321, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Slider.blockColor({ "id": 16777273, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            Slider.selectedColor({ "id": 16777273, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            Slider.trackColor({ "id": 16777276, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
